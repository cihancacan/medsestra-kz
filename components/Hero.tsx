...
export function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#071827] pt-20">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-5rem)] max-w-7xl items-start justify-center px-5 pb-8 pt-8 text-center md:items-center md:px-8 md:py-12 lg:py-16">
        <div className="mx-auto max-w-2xl pt-1 md:pt-0">
          <div className="mx-auto inline-flex items-center gap-2 rounded-full bg-white/90 px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.14em] text-[#1677A8] shadow-sm ring-1 ring-[#D7EEF7] backdrop-blur md:px-4 md:py-2 md:text-xs md:tracking-[0.16em]">
            <span className="h-2 w-2 rounded-full bg-[#23A6D5]" />
            Nurse care in Almaty
          </div>

          <h1 className="mx-auto mt-4 max-w-3xl text-[2.55rem] font-black leading-[0.92] tracking-[-0.07em] text-[#071827] md:mt-7 md:text-7xl lg:text-[5.4rem]">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-[#071827]/68 md:mt-7 md:text-xl md:leading-9">
            Медсестра на дом, Family Care, Corporate Care и Beauty IV. Напишите в WhatsApp или позвоните — мы организуем визит.
          </p>

          <div className="mx-auto mt-5 flex max-w-xl flex-col justify-center gap-2 sm:flex-row md:mt-8 md:gap-3">
