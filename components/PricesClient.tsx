...
const groups = {
  RU: [
    ...
    ['Забота о родителях', [['Family Care Start','от 149 000 ₸ / месяц','Базовый формат сопровождения'],['Family Care Plus','от 249 000 ₸ / месяц','Больше визитов и приоритет']]],
    ['Медсестра в офис', [['Wellness Day','по запросу','Для команды или офиса'],['Корпоративная медсестра','по запросу','По графику компании']]],
    ['Beauty & Wellness IV', [['Vitamin IV','от 30 000 ₸','После оценки специалиста'],['Glow Beauty IV','от 35 000 ₸','Beauty & wellness формат'],['Recovery IV','от 35 000 ₸','Восстановление после вечеринки']]]
  ],
  KZ: [
    ...
    ['Ата-анаға күтім', [['Family Care Start','149 000 ₸ / ай бастап','Базалық сүйемелдеу форматы'],['Family Care Plus','249 000 ₸ / ай бастап','Көбірек визит және басымдық']]],
    ['Кеңсеге медбике', [['Wellness Day','сұраныс бойынша','Команда немесе кеңсе үшін'],['Корпоративтік медбике','сұраныс бойынша','Компания кестесі бойынша']]],
    ['Beauty & Wellness IV', [['Vitamin IV','30 000 ₸ бастап','Маман бағалауынан кейін'],['Glow Beauty IV','35 000 ₸ бастап','Beauty & wellness форматы'],['Recovery IV','35 000 ₸ бастап','Кештен кейін қалпына келу']]]
  ],
  EN: [
    ...
    ['Corporate Care', [['Wellness Day','on request','For team or office'],['Corporate nurse','on request','According to company schedule']]],
    ['Beauty & Wellness IV', [['Vitamin IV','from 30,000 ₸','After specialist assessment'],['Glow Beauty IV','from 35,000 ₸','Beauty & wellness format'],['Recovery IV','from 35,000 ₸','After-party recovery']]]
  ]
};
