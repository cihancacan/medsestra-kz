...
const cards = {
  RU: [['Медсестра на дом','Уколы, перевязки, снятие швов, контроль состояния и регулярные визиты.'],['Семейный уход','Регулярные визиты, базовый контроль, сопровождение и короткая обратная связь семье.'],['Корпоративный уход','Выезд медсестры, дни заботы о здоровье, поддержка сотрудников и руководителей.'],['Капельницы красоты и восстановления','Восстановление, энергия и водный баланс организма.']],
  KZ: [['Үйге медбике','Укол, таңу, тігіс алу, жағдайды бақылау және тұрақты визиттер.'],['Отбасылық күтім','Тұрақты визиттер, негізгі бақылау, сүйемелдеу және отбасыға қысқа есеп.'],['Корпоративтік күтім','Кеңсеге медбике шығуы, денсаулық күндері және қызметкерлерге қолдау.'],['Сұлулық және қалпына келтіру тамшылары','Қалпына келу, энергия және ағзаның су теңгерімі.']],
  EN: [['Nurse at home','Injections, dressings, stitch removal, condition checks and regular visits.'],['Family care','Regular visits, basic monitoring, support and short family feedback.'],['Corporate care','Office nurse visits, health days, support for employees and executives.'],['Beauty and recovery IV','Beauty drips, recovery, energy and hydration.']]
};
