...
const bulletCards = {
  RU: ['Медсёстры отобраны', 'Документы проверены', 'Качество контролируется', 'Связь после визита'],
  KZ: ['Медбикелер таңдалған', 'Құжаттар тексерілген', 'Сапа бақыланады', 'Визиттен кейін байланыс бар'],
  EN: ['Selected nurses', 'Documents checked', 'Quality controlled', 'Support after the visit']
};
