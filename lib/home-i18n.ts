...
export const homeText = {
  RU: {
    ...
    text: 'Medsestra.kz организует выезд медсестры на дом: уколы, капельницы по показаниям, перевязки, снятие швов, уход за родителями, корпоративный уход и восстановительные процедуры.',
  ...
  KZ: {
    ...
    text: 'Medsestra.kz үйге медбике визитін ұйымдастырады: укол, көрсетілім бойынша тамшылату, таңу, тігіс алу, ата-анаға күтім, корпоративтік күтім және қалпына келтіру қызметтері.',
  ...
  EN: {
    ...
    text: 'Medsestra.kz organizes nurse visits at home: injections, IV drips when appropriate, dressings, stitch removal, care for parents, corporate care and recovery services.',
...
export const homeTrust = {
  RU: [['Проверенные медсёстры','Документы, опыт и качество общения проверяются до визита.'],['Чистый протокол','Стерильные материалы, спокойная подготовка и аккуратный процесс.'],['Один контакт','WhatsApp, телефон и email для записи и уточнений.'],['Дом, семья, офис','Разовые визиты, семейный уход, корпоративные программы и восстановительные процедуры.']],
  KZ: [['Тексерілген медбикелер','Құжаттар, тәжірибе және қарым-қатынас сапасы алдын ала тексеріледі.'],['Таза протокол','Стерильді материалдар, тыныш дайындық және мұқият процесс.'],['Бір байланыс','Жазылу және нақтылау үшін WhatsApp, телефон және email.'],['Үй, отбасы, кеңсе','Бір реттік визиттер, отбасылық күтім, корпоративтік бағдарламалар және қалпына келтіру қызметтері.']],
...
export const homeServices = {
  RU: [['Медсестра на дом','Уколы, перевязки, снятие швов, контроль состояния и регулярные визиты.'],['Семейный уход','Регулярные визиты, базовый контроль и короткая обратная связь семье.'],['Корпоративный уход','Выезд медсестры, дни заботы о здоровье и поддержка сотрудников или руководителей.'],['Капельницы красоты и восстановления','Восстановление, энергия и водный баланс организма.']],
  KZ: [['Үйге медбике','Укол, таңу, тігіс алу, жағдайды бақылау және тұрақты визиттер.'],['Отбасылық күтім','Тұрақты визиттер, негізгі бақылау және отбасыға қысқа кері байланыс.'],['Корпоративтік күтім','Кеңсеге медбике шығуы, денсаулық күндері және қызметкерлерге қолдау.'],['Сұлулық және қалпына келтіру тамшылары','Қалпына келу, энергия және ағзаның су теңгерімі.']],
  EN: [['Nurse at home','Injections, dressings, stitch removal, condition checks and regular visits.'],['Family care','Regular visits, basic monitoring and short feedback to the family.'],['Corporate care','Office nurse visits, health days and support for teams or executives.'],['Beauty and recovery IV','Recovery, energy and hydration.']]
};

export const homeSteps = { RU: [['01','Выберите услугу','Дом, семья, офис или восстановительные процедуры.'],['02','Напишите в WhatsApp','Укажите район, время, услугу и контакт.'],['03','Подтвердите визит','Мы назначаем медсестру и остаёмся на связи.']], KZ: [['01','Қызметті таңдаңыз','Үй, отбасы, кеңсе немесе қалпына келтіру қызметі.'],['02','WhatsApp арқылы жазыңыз','Аудан, уақыт, қызмет және байланыс көрсетіңіз.'],['03','Визитті растаңыз','Біз медбикені тағайындап, байланыста боламыз.']], EN: [['01','Choose a service','Home, family, office or recovery care.'],['02','Message on WhatsApp','Share district, time, service and contact.'],['03','Confirm the visit','We assign a nurse and stay in touch.']] };
